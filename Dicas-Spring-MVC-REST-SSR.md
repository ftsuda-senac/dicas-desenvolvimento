...
3. [Controllers REST](#3-controllers-rest)
    - [3.1 Estrutura Completa de um Controller REST](#31-estrutura-completa-de-um-controller-rest)
    - [3.2 DTOs com Records (Java 16+)](#32-dtos-com-records-java-16)
    - [3.3 Mapeamento de Método HTTP com Exemplos Práticos](#33-mapeamento-de-método-http-com-exemplos-práticos)
...
8. [Tratamento de Erros](#8-tratamento-de-erros)
    ...
    - [8.4 Tratamento de Erros em SSR (Páginas de Erro Thymeleaf)](#84-tratamento-de-erros-em-ssr-páginas-de-erro-thymeleaf)
